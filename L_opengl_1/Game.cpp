...
Game::Game()
{
    ...
    /* --- init crisis model --- */
    crisisShader = new ShaderLoader("resources/shaders/modelLoading.vs", "resources/shaders/modelLoading.frag");
    crisisModel = new ModelLoader("resources/models/nanosuit2.obj");
